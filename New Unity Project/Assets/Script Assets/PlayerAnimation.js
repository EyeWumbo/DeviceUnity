...
=======
>>>>>>> 11c84b0b22b730783612c3499c467833b899b49d
var walks = [];
...
var playerRunCycle:int = 0;//Which column will be drawn when running (last column is only drawn when idle)
var playerRunCycleAddition:int = 1;
var playerTextureY:int = 0;//Which row will be drawn (according to the direction the character is facing; also currently not working correctly)
=======
<<<<<<< HEAD
=======
>>>>>>> de3b6f403ed832fdf54672f26ec53b0886a42618
		...
		if((playerObject.transform.position - end).magnitude < dir.magnitude){
			...
			if(playerRunFrameDelay == ANIMATION_DELAYPERFRAME){
				if(playerRunCycle == SPRITESHEET_X_NUMWALK-1)
					...
					playerRunCycleAddition = 1;
				playerRunCycle += playerRunCycleAddition;
				playerRunFrameDelay = 0;
			}else{
				playerRunFrameDelay++;
			}
